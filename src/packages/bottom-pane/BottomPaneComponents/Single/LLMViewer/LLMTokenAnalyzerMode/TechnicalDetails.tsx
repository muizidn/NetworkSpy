...
export const TechnicalDetails: React.FC<TechnicalDetailsProps> = ({
  ...
  return (
    <div className="w-1/3 flex flex-col bg-[#111314] overflow-hidden">
      ...
      <div className="p-4 border-t border-zinc-900 bg-black/20 text-[9px] text-zinc-600 font-black tracking-widest text-center shrink-0">
